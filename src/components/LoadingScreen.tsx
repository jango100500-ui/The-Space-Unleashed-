...
const SOUND_LIST = [
  ...
  { key: 'proton3', url: '/sounds/proton3.mp3' },
  { key: 'brother1', url: '/sounds/brother1.mp3' },
  { key: 'brother2', url: '/sounds/brother2.mp3' },
  { key: 'xwingFlyby', url: '/sounds/xwing-flyby.mp3' },
  { key: 'thunder1', url: '/sounds/thunder1.mp3' },
  { key: 'thunder2', url: '/sounds/thunder2.mp3' },
  { key: 'nosignal', url: '/sounds/nosignal.mp3' },
  { key: 'heal1', url: '/sounds/HealSound1.mp3' },
  { key: 'heal2', url: '/sounds/HealSound2.mp3' },
  { key: 'heal3', url: '/sounds/HealSound3.mp3' },
  { key: 'heal4', url: '/sounds/HealSound4.mp3' },
  { key: 'mine', url: '/sounds/mine.mp3' },
  { key: 'slave1', url: '/sounds/slave1.mp3' },
  { key: 'slave12', url: '/sounds/slave12.mp3' },
    ...
    const runLoading = async () => {
      ...
      try {
        ...
        try {
          ...
          g.add(new THREE.Mesh(new THREE.CylinderGeometry(1.2, 1.2, 14, 8), new THREE.MeshStandardMaterial({ color: 0xcccccc })));
          loadedCr90 = g;
        }
