    ...
    abilities: [
      {
        ...
        description: 'Огневой налет пары X-Вингов из-за спины по ближайшим врагам с быстрым маневром расхождения. Перезарядка: 25 секунд',
        symbol: 'triangle'
      },
      {
        id: 'proton_torpedo',
        ...
        description: 'Самонаводящаяся протонная бомба. Выводит корабли из строя с последующей детонацией. Перезарядка: 26 секунд',
        symbol: 'circle'
      }
    ]
  },
