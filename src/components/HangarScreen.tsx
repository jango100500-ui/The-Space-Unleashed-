    ...
    abilities: [
      {
        ...
        description: 'Огневой налет пары X-Вингов из-за спины по ближайшим врагам с быстрым маневром расхождения. Перезарядка: 25 секунд после завершения',
        symbol: 'triangle'
      },
      {
        id: 'proton_torpedo',
        ...
        description: 'Самонаводящаяся протонная бомба. Выводит корабли из строя с последующей детонацией. Перезарядка: 26 секунд после попадания',
        symbol: 'circle'
      }
    ]
  },
    ...
    abilities: [
      {
        ...
        typeText: 'БАЗОВАЯ СПОСОБНОСТЬ',
        description: 'Восстанавливает 80% от текущего состояния корпуса за счёт работы аварийных ремонтных дронов. Перезарядка: 125 секунд',
        symbol: 'triangle'
      },
      {
        id: 'rage',
        name: 'БУЙСТВО',
        typeText: 'ОСОБАЯ СПОСОБНОСТЬ',
        description: 'Перегрузка генератора на 8 секунд: наносимый урон удваивается, а входящий урон снижается на 50%. Перезарядка: 30 секунд после окончания',
        symbol: 'circle'
      }
    ]
  },
  {
    ...
    abilities: [
      ...
      },
      {
        ...
        name: 'УДАРНЫЙ РЕЖИМ',
        typeText: 'РЕЖИМ ОГНЯ',
        description: 'Переводит огонь на крылья: выпускает пару тяжелых снарядов с низкой скорострельностью и разбросом, ваншотающих вражеские истребители. Перезарядка переключения: 10 секунд',
        symbol: 'circle'
      }
    ]
  },
    ...
    abilities: [
      {
        ...
        typeText: 'БАЗОВАЯ СПОСОБНОСТЬ',
        description: 'Очередной запуск 6 маневренных самонаводящихся ракет с красным шлейфом. 2 ракеты на истребитель. Перезарядка: 24 секунды после попадания',
        symbol: 'triangle'
      },
      {
        id: 'signal_reroute',
        ...
        typeText: 'ОСОБАЯ СПОСОБНОСТЬ',
        description: 'На 8 секунд включает «СОПРОТИВЛЕНИЕ»: входящий урон снижен на 60%, корабль иммунен к оглушению. Перезарядка: 40 секунд после окончания',
        symbol: 'circle'
      },
      {
        id: 'ion_charge',
        name: 'ИОННЫЙ ЗАРЯД',
        typeText: 'СУПЕРОРУЖИЕ',
        description: 'Выпуск заряда вперед с торможением. Детонирует гигантским голубым взрывом с двойной воронкой, гарантированно уничтожая всех в радиусе. Перезарядка: 45 секунд',
        symbol: 'square'
      }
    ]
  }
